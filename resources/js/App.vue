<template>
    <div class="min-h-screen bg-cover bg-center bg-no-repeat bg-wbg">
        <div class="min-h-[inherit] flex flex-col justify-center p-32">
            <div class="max-w-2xl mx-auto w-full">
                <div class="bg-white pt-30 px-30 pb-20">
                    <!-- Header -->
